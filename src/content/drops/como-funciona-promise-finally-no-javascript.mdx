...
informaldesc: "👉 No *Drop* de hoje falei sobre o método `.finally()`, uma
  adição do ES2018 para melhorar a maneira que lidamos com operações assíncronas
...
💡 Antes desse recurso, era preciso um **reflect** para alcançar um objetivo semelhante.
