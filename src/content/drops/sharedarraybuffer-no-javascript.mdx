...
informaldesc: >-
  ...
  🧵 E no drop de hoje falei sobre o objeto *SharedArrayBuffer*, um recurso bem poderoso, mas que por sua natureza especifica de problemas, , é pouco falado. Espero que gostem de conhecer esse recurso, que inclusive, aplica características de multi-threading ao ambiente de desenvolvimento JavaScript.
category: tech
lang: pt
external: false
---
