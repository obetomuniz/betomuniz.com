...
🕸 A **Web Share API** promove acesso ao fluxo natural de compartilhamento de conteúdo da plataforma em que estamos executando aplicações que utilizam tecnologias web.
