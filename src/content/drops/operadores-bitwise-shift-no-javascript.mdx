...
informaldesc: 💥 No drop de hoje compilei ao máximo e expliquei o que são e como
  se comportam *Operadores Bitwise Shift* no JavaScript. Apesar de ser um
  assunto relativamente denso e teórico, acredito que ficou beeem legal. Espero
  que gostem, e fica à dica para se aprofundarem mais nisso caso se interessem.
category: tech
lang: pt
external: false
---
