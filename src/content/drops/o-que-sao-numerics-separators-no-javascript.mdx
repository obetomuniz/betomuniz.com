...
title: O que são Numerics Separators no JavaScript?
slug: o-que-sao-numerics-separators-no-javascript
featured:
  - https://res.cloudinary.com/beto-muniz/image/upload/f_auto/v1601434483/Titulo_Image_Site_mj5mbf.jpg
...
🔢 [Numerics Separators](https://github.com/tc39/proposal-numeric-separator) é uma notação que serve para melhorar a legibilidade de números.
