...
Enquanto o React Native aplica o conceito de [bridge](https://facebook.github.io/react-native/docs/communication-ios), Flutter elimina isso completamente, pois com Flutter você não depende de um "tradutor" entre o Reino Nativo e o Reino JavaScript. 

A linguagem Dart através do framework Flutter irá realmente compilar código nativo para iOS e Android.
